...
internal class BezierView @JvmOverloads constructor(
    context: Context,
    ...
    private var outerArray: Array<PointF> = Array(11) { PointF() }
    private var innerArray: Array<PointF> = Array(11) { PointF() }
    private var progressArray: Array<PointF> = Array(11) { PointF() }

    private var width = 0f
    private var height = 0f

    var bezierOuterWidth = 72f.dp(context)
        set(value) {
            field = value
            invalidate()
        }

    var bezierOuterHeight = 8f.dp(context)
        set(value) {
            field = value
            invalidate()
        }

    var bezierInnerWidth = 124f.dp(context)
        set(value) {
            field = value
            invalidate()
        }

    var bezierInnerHeight = 16f.dp(context)
        set(value) {
            field = value
            invalidate()
        }

    var shadowHeight = 8f.dp(context)
        set(value) {
            field = value
            invalidate()
        }

    var color = Color.parseColor("#CCCCCC")
        set(value) {
            field = value
    ...
    var shadowColor = Color.parseColor("#000000")
        set(value) {
            field = value
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        outerArray[0].set(0f, bezierOuterHeight + extra)
        outerArray[1].set((bezierX - bezierOuterWidth / 2), bezierOuterHeight + extra)
        outerArray[2].set(bezierX - bezierOuterWidth / 4, bezierOuterHeight + extra)
        outerArray[3].set(bezierX - bezierOuterWidth / 4, extra)
        outerArray[4].set(bezierX, extra)
        outerArray[5].set(bezierX + bezierOuterWidth / 4, extra)
        outerArray[6].set(bezierX + bezierOuterWidth / 4, bezierOuterHeight + extra)
        outerArray[7].set(bezierX + bezierOuterWidth / 2, bezierOuterHeight + extra)
        outerArray[8].set(width, bezierOuterHeight + extra)
        outerArray[9].set(width, height)
        outerArray[10].set(0f, height)
    }
